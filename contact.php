<?php
  ...
  $mail->Username   = "anjaneyamustoor167@gmail.com";
  $mail->Password   = "Alien#2001";

  $success = "";
  $error = "";
  $name = $message = $email = "";
  $errors = array('name' => '', 'email' => '', 'message' => '');
  $mymail = 'anjiuvce@gmail.com';
  $myname = 'Quiz Master';
  ...
  if (isset($_POST["submit"])) 
  {
    ...
    else 
    {
        try 
        {
              $mail->setFrom('anjaneyamustoor167@gmail.com', 'Quiz Master');
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-8 mx-auto text-center">
            <span class="badge badge-warning badge-pill mb-3">Contact Form</span>
          </div>
        </div>
                    ...
                    <div class="offset-md-3 text-justify-content-end">
                      <div class="btn-group" role="group">
                        <a
                          role="button"
                          class="btn btn-info"
                          href="tel:+917975007550"
                          ><i class="fa fa-phone"></i> Call</a
                        >
                        <a role="button" class="btn btn-success" target="_blank" href="http://wa.me/7975007550?text=Message%20From%20Exam%20Portal." 
                          ><i class="fa fa-whatsapp"></i> Whatsapp</a
                        >
                        <a
                          role="button"
                          class="btn btn-primary"
                          href="mailto:anjaneyamustoor167@gmail.com"
